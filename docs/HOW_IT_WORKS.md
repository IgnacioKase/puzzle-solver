...
| File | Responsibility |
|---|---|
| [`scripts/solve.py`](../scripts/solve.py) | Perspective correction, piece extraction, inventory, and SIFT candidates |
| [`scripts/dense.py`](../scripts/dense.py) | Coarse search using masked artwork correlation |
| [`scripts/refine.py`](../scripts/refine.py) | Local refinement and gap-coverage assessment |
| [`scripts/publish.py`](../scripts/publish.py) | Confidence classification, overlap reporting, neighbors, and guide data |
| [`scripts/starter.py`](../scripts/starter.py) | Five-piece starter illustration |
| [`output/index.html`](../output/index.html) | Interactive viewer and browser-local progress |
| [`output/guide-data.json`](../output/guide-data.json) | Published placements and confidence labels |

The [README](../README.md) explains how to open the guide and reproduce the analysis.

![A concrete five-piece placement example](../output/start-here.jpg)
